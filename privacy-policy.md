...
for the purpose of processing transactions in the Txchangecoin Network in encrypted form.

## App permissions
- INTERNET : Connect to the Txchangecoin Network via Txchangecoin Daemon Node
